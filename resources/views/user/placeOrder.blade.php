            ...
            <div class="nk-content-body">
                ...
                <div class="forex-interface row g-2">
                    ...
                    <div class="col-lg-12 d-flex justify-content-between">
                        <input type="button" value="- 0.1" id="decrease-lot-a" class="text-center border-0 place-order-symbols">
                        <input type="button" value="- 0.01" id="decrease-lot-b" class="text-center border-0 place-order-symbols">
                        <input type="number" value="0" id="lot-size" step="0.01" class="text-center border-0 place-order-symbols">
                        <input type="button" value="+ 0.01" id="increase-lot-a" class="text-center border-0 place-order-symbols">
                        <input type="button" value="+ 0.1" id="increase-lot-b" class="text-center border-0 place-order-symbols">
                    </div>

                    <div class="col-lg-12 d-flex justify-content-center">
                        <input type="number" class="text-center border-0 place-order-symbols" placeholder="Entry Price" id="lp">
                    </div>

                    <div class="col-lg-12 d-flex justify-content-center">
                        <div class="w-50">
                            <input type="button" value="-" class="sl-plus-btn bg-danger text-white fw-bold" onclick="SLdecrease()">
                            <input type="number" value="" placeholder="STOP LOSS" class="text-center sl-field">
                            <input type="button" value="+" class="sl-minus-btn bg-danger text-white fw-bold" onclick="SLincrease()">
                        </div>
                        <div class="w-50">
                            <input type="button" value="-" class="tp-plus-btn bg-success text-white fw-bold" onclick="TPdecrease()">
                            <input type="text" value="" placeholder="TAKE PROFIT" class="text-center tp-field">
                            <input type="button" value="+" class="tp-minus-btn bg-success text-white fw-bold" onclick="TPincrease()">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 d-flex justify-content-center mb-5">
                        <button type="button" class="sellOrder btn btn-danger mx-1 w-100 d-flex justify-content-center">SELL <em class="icon ni ni-trend-down"></em></button>
                        <button type="button" class="buyOrder btn btn-success mx-1 w-100 d-flex justify-content-center">BUY <em class="icon ni ni-trend-up"></em></button>
                    </div>
                </div>
            </div>
        </div>
          ...
          $('#market').change(function (e) {
            ...
            $('#symbols').change(function (e) {
                ...
                if (market == 'forex') {
                    ...
                    $.getJSON('https://api.fastforex.io/fetch-multi?from='+from+'&to='+to+'&api_key=4d39c755a9-e34f008a19-ru9wj5',
                        function (data) {
