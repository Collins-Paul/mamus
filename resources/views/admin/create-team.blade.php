        ...
        <div class="nk-content-body">
            <div class="nk-block-head nk-block-head-lg wide-sm">
                <div class="nk-block-head-content">
                    ...
                    <h4 class="nk-block-title fw-normal">Create Member</h4>
                </div>
            </div>

            <div class="card card-bordered card-preview">
                <div class="card-inner">
                    <form action="{{ route('admin.create.team.member') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                                    ...
                                    <div class="card items">
                                        <div class="card-body" style="width: 200px">
                                            <div class="items-img position-relative" style="width: 100%">
                                                <img src="{{ asset('assets/images/dummy-profile-pic.png') }}" id="blah" class="img-fluid rounded mb-3" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            ...
                                            name="name" placeholder="Enter name of staff" required="">
                                            @error('name')
                                            <span id="-error" class="invalid text-danger">{{ $message }}</span>
                                            @enderror
                                            </div>
                                ...
                                <div class="col-lg-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <textarea placeholder="A brief description of the staff..." class="form-control" name="description" rows="10"></textarea>
                                            @error('description')
                                            <span id="-error" class="invalid text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
