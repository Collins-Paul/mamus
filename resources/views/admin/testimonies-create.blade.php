                        ...
                        <div class="row">
                                ...
                                <div class="col-lg-8 mb-3">
                                    <div class="form-group">
                                        <label class="form-label" for="fva-full-name">Name<span class="text-danger">*</span></label>
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control"
                                            name="name" placeholder="Enter award title" required="">
                                            @error('name')
                                            <span id="-error" class="invalid text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="col-lg-8 mb-3">
                                    <div class="form-group">
                                        <label class="form-label" for="fva-full-name">Testimony<span class="text-danger">*</span></label>
                                        <div class="form-control-wrap">
                                            <textarea class="form-control"  name="testimony" rows="10" placeholder="Type testimony here..."></textarea>
                                            @error('testimony')
                                            <span id="-error" class="invalid text-danger">{{ $message }}</span>
                                            @enderror
                                            </div>
